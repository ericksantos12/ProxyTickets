...
export const GuildChannelOrderByRelevanceFieldEnum = {
  name: 'name',
  id: 'id',
  url: 'url',
  guildId: 'guildId'
...
export type GuildChannelOrderByRelevanceFieldEnum = (typeof GuildChannelOrderByRelevanceFieldEnum)[keyof typeof GuildChannelOrderByRelevanceFieldEnum]
